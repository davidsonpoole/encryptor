...
public class AESEncryptor {
    ...
    private int[] rc = {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36};
    ...
    // Expand AES key to 15 16-byte round keys
    ...
    private int[] schedule_core(int[] in, int i) {
    ...
    private int[][] shiftRowsLeft(int[][] input) {
        for (int i=1; i<4;i++) {
    ...
    private int[][] shiftRowsRight(int[][] input) {
        for (int i=1; i<4;i++) {
            input[i] = rotWord(input[i], -i);
        }
        return input;
    ...
    private int[] rotWord(int[] initial, int offset) {
    ...
    private int subByte(int initial) {
        return sbox[initial];
    }

    private int subInverse(int input) {
        return inv_s[input];
    }
